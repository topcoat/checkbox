...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        stylus: {
            compile: {
                options: {
                    paths: ['node_modules/topcoat-checkbox-base/src/mixins', 'node_modules/topcoat-utils/src/mixins', 'node_modules/topcoat-theme/src'],
                    import: ['utils', 'theme-topcoat-mobile-light'],
                    compress: false
                },
